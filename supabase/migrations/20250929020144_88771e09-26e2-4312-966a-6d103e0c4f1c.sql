...
drop policy if exists "owners read/write businesses" on businesses;
drop policy if exists "owners read/write campaigns" on campaigns;
drop policy if exists "owners read/write campaign_items" on campaign_items;
